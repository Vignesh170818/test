...
from coreengine.util.llmmodel import GenLiteLLMModel

class GenLiteMainForm(FlaskForm):
    '''Main Form'''
    llm_platform_options = GenLiteLLMModel().get_llmmodels_selectfield()

    '''Industry Form'''
    industrychoices = GenLiteIndustry().get_industry_choices()
